...
var _open_with_record = require("./open_with_record");
...
function () {
  ...
  function BlockSdk(airtableInterface) {
    ...
    (0, _defineProperty2.default)(this, "openWithRecord", void 0);
    ...
    this.openWithRecord = new _open_with_record.OpenWithRecord(airtableInterface);
...
(0, _defineProperty2.default)(BlockSdk, "VERSION", "0.0.47");